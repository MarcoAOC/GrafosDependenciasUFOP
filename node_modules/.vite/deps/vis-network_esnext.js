...
var require_keycharm = __commonJS({
  "node_modules/keycharm/keycharm.js"(exports, module) {
    "use strict";
...
var require_timsort = __commonJS({
  "node_modules/timsort/build/timsort.js"(exports) {
    (function(global, factory) {
      ...
      var TimSort2 = function() {
        function TimSort3(array2, compare) {
          _classCallCheck(this, TimSort3);
          this.array = null;
          this.compare = null;
        ...
        TimSort3.prototype.pushRun = function pushRun(runStart, runLength) {
          this.runStart[this.stackSize] = runStart;
          this.runLength[this.stackSize] = runLength;
          this.stackSize += 1;
        };
        TimSort3.prototype.mergeRuns = function mergeRuns() {
        ...
        TimSort3.prototype.forceMergeRuns = function forceMergeRuns() {
          while (this.stackSize > 1) {
            var n = this.stackSize - 2;
        ...
        TimSort3.prototype.mergeAt = function mergeAt(i) {
        ...
        TimSort3.prototype.mergeLow = function mergeLow(start1, length1, start2, length2) {
          var compare = this.compare;
          var array2 = this.array;
          var tmp = this.tmp;
          var i = 0;
        ...
        TimSort3.prototype.mergeHigh = function mergeHigh(start1, length1, start2, length2) {
          var compare = this.compare;
          var array2 = this.array;
          var tmp = this.tmp;
          var i = 0;
      ...
      function sort2(array2, compare, lo, hi) {
        ...
        var ts = new TimSort2(array2, compare);
...
var require_timsort2 = __commonJS({
  "node_modules/timsort/index.js"(exports, module) {
    module.exports = require_timsort();
  }
});

// node_modules/vis-network/esnext/esm/vis-network.js
var import_component_emitter = __toESM(require_component_emitter());
var import_keycharm = __toESM(require_keycharm());
var import_timsort = __toESM(require_timsort2());
  ...
  configureKeyboardBindings() {
    ...
    if (this.options.keyboard.enabled === true) {
      if (this.options.keyboard.bindToWindow === true) {
        this.keycharm = (0, import_keycharm.default)({ container: window, preventDefault: true });
      } else {
        this.keycharm = (0, import_keycharm.default)({
...
var SingleTypeSelectionAccumulator = class {
  constructor() {
    _SingleTypeSelectionAccumulator_previousSelection.set(this, /* @__PURE__ */ new Set());
    _SingleTypeSelectionAccumulator_selection.set(this, /* @__PURE__ */ new Set());
  }
  get size() {
...
_SingleTypeSelectionAccumulator_previousSelection = /* @__PURE__ */ new WeakMap(), _SingleTypeSelectionAccumulator_selection = /* @__PURE__ */ new WeakMap();
...
_SelectionAccumulator_nodes = /* @__PURE__ */ new WeakMap(), _SelectionAccumulator_edges = /* @__PURE__ */ new WeakMap(), _SelectionAccumulator_commitHandler = /* @__PURE__ */ new WeakMap();
...
var VerticalStrategy = class extends DirectionInterface {
  ...
  /** @inheritDoc */
  sort(nodeArray) {
    (0, import_timsort.sort)(nodeArray, function(a, b) {
      return a.x - b.x;
    });
  }
  /** @inheritDoc */
...
var LayoutEngine = class {
    ...
    if (this.options.hierarchical.enabled === true) {
      ...
      if (allOptions2.edges === void 0) {
        ...
        if (typeof allOptions2.edges.smooth === "boolean") {
          this.optionsBackup.edges = { smooth: allOptions2.edges.smooth };
  ...
  _getHubSizes() {
    ...
    import_timsort.default.sort(result, function(a, b) {
      return b - a;
    });
    return result;
  }
  ...
  _createWrappers() {
    ...
    if (this.closeDiv === void 0) {
      ...
      this.closeDiv.setAttribute(
        "aria-label",
        ((_a = this.options.locales[this.options.locale]) == null ? void 0 : _a["close"]) ?? this.options.locales["en"]["close"]
      );
...
function Network(container, data, options2) {
...
(0, import_component_emitter.default)(Network.prototype);
Network.prototype.setOptions = function(options2) {
  if (options2 === null) {
    options2 = void 0;
  }
  if (options2 !== void 0) {
    const errorFound = Validator.validate(options2, allOptions);
    if (errorFound === true) {
      console.error(
...
vis-network/esnext/esm/vis-network.js:
  (**
   * vis-network
   ...
   *)
*/
//# sourceMappingURL=vis-network_esnext.js.map
